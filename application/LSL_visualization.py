...
class LSLgui(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi("application/Visuals/LSL_visualization_copy.ui", self) # Load the .ui file
    ...
    def checkVisual(self):
        if self.graphOption == "Time-Series":
            self.showTSStream()
    ...
    def visual_changed(self, s): # s is a str 
        self.graphOption = s
    ...
    def initUI(self):
        ...
        self.visualBtn = self.findChild(QPushButton, 'visualizeBtn')

        self.visualOptions = self.findChild(QComboBox, 'visualOptions')
        self.visualOptions.addItems(["Time-Series", "Frequency", "Time-Freq"])
        self.visualOptions.currentIndexChanged[str].connect(self.visual_changed)
